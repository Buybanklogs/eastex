				...
				html = `
					<tr>
						...
						<td class="title" style="text-align: left; padding-left: 10px">
							<input type="checkbox" id="_ifpl" name="_ifpl" value="1">
							` + rcmail.gettext('ifpl_rememberme', 'persistent_login') + `</td>
					</tr>
					<tr id="ifpl-hint" style="display: none;">
						<td></td>
						<td class="ifpl-hint" style="padding: 5px; text-align: center">
							` + rcmail.gettext('ifpl_rememberme_hint', 'persistent_login') + `</td>
					</tr>
				`;
			}
